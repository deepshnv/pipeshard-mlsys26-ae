...
#define GGML_CUDA_MAX_SPLITS    128
#define GGML_CUDA_MAX_DEVICES   GGML_CUDA_MAX_SPLITS
...
extern "C" {
    ...
    enum ggml_tensor_flag {
        ...
        GGML_TENSOR_FLAG_KV     = 16,
        GGML_TENSOR_FLAG_LORA   = 32,
        GGML_TENSOR_FLAG_LEAF   = 64,
    };
    ...
    struct ggml_tensor {
        ...
        int buffer_id; // The ID of the buffer where the tensor is stored.
                       // This is used by the pipeline executor to manage memory.
