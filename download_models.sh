...
ensure_dir "$MODELS_ROOT/nemovision4B"
...
echo "[~] nemotron-vision-4b-instruct-f16"
echo "    Skipped (URL not yet available). Update this script when the model is released."
echo ""
...
echo "  1. Download and extract the two NVIDIA ACE .7z archives (see URLs above)."
echo "  2. Place nemotron-vision-4b weights when available."
echo ""
echo "Expected layout:"
echo "  gguf_models/"
echo "    minitron4B/          (manual)"
echo "    minitron8B/          (manual)"
echo "    nemovision4B/        (pending)"
