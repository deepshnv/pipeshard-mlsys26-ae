...
struct llama_model_loader {
    ...
    std::unordered_map<std::string, void *> tensor_data_map;
    ...
    void get_mapping_range_all(size_t * first, size_t * last, void ** addr, int idx, ggml_context * ctx) const;																											   
    ...
    void * get_tensor_data(const std::string & name) const;
};
