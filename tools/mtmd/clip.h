...
struct clip_context_params {
    ...
    int32_t clip_img_size;         // override max image dim (-1 = model default)
    bool vto_offload_cpu;          // offload clip weights to CPU, stream at runtime
    bool vto_tiled_attention;      // tile Q to reduce peak VRAM of O(N^2) KQ,V tensors
    int32_t clip_tiled_mb;         // budget in MiB for CLIP tiled Q attention
};
