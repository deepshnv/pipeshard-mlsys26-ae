...
int main(int argc, char ** argv) {
    ...
    // pipeshard: set draft VRAM budget (0 = all layers on CPU via pipeshard)
    if (params.pipe_shard) {
        params.max_vram_alloc = params.speculative.max_vram_alloc;
        params.n_gpu_layers   = 1000000;  // pipeshard manages layer placement
